...
2. **AI-Assisted Generation:** Utilize advanced LLMs (Google Gemini) to automatically generate system architectures, manifestos, and technical proposals based on natural language prompts.
...
- **AI Integration:** Google Gemini API (`@google/genai`) for natural language processing and graph generation.
